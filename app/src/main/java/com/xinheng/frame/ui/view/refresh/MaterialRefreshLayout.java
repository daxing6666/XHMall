...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        setWaveHeight(dip2px(context, waveHeight));
        setHeaderHeight(dip2px(context, headHeight));

        mMaterialHeaderView = new MaterialHeaderView(context);
        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(context, hIGHER_HEAD_HEIGHT));
        ...
        LayoutParams layoutParams2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(context, hIGHER_HEAD_HEIGHT));
